...
class report_queryController extends report_queryControllerGenerate
{
    ...
    function saveFormPost()
    {
        ...
        $this->report_query->setEntrytime($entrytime);
	    $this->report_query->setEntryuser($entryuser);
	    $this->report_query->setEntryip($entryip);
	    $this->report_query->setUpdatetime($id!=''?$entrytime:null);
	    $this->report_query->setUpdateuser($id!=''?$entryuser:null);
	    $this->report_query->setUpdateip($id!=''?$entryip:null);
