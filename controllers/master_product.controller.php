...
class master_productController extends master_productControllerGenerate
{
    ...
    function getPartDet()
    {
        ...
        foreach ($list_part as $val_part) {
            ...
            $table .= "<td><input type='text' name='price[]' id='t" . $no . "_price' value='" . $val_part->getHrg_jual() . "'/><input type='text' name='edprice[]' id='t" . $no . "_edprice' value='" . number_format($val_part->getHrg_jual(), 0) . "' class='form form-control' onKeyPress='priceReg(this,event)' onKeyUp='priceReg(this)' ></td>";
