...
class master_productController extends master_productControllerGenerate
{
    ...
    function getPartDet()
    {
        ...
        foreach ($list_part as $val_part) {
            ...
            $table .= "<td><input type='text' name='qtyBeli[]' id='t" . $no . "_qtyBeli' class='form form-control' onkeypress='validate(event);' value='' placeholder='Quantity Beli (Pcs)' onblur='jshitung(this)' /></td>";
