    ...
    <table>
        <tr>
            ...
            <td><input type="text" class="form form-control" style="text-align: right;" onkeypress="validate(event);"
                    name="id" id="id" value="<?php echo $master_product_->getId(); ?>" size="40" ReadOnly
        ...
        <tr>
            ...
            <td><input type="text" class="form form-control" name="nm_product" id="nm_product"
                    value="<?php echo $master_product_->getNm_product(); ?>" size="40"></td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="text" class="form form-control" name="hrg_modal" id="hrg_modal"
                    value="<?php echo $master_product_->getHrg_modal(); ?>" size="40" onkeypress="setHarga()"
                    onkeyup="setHarga()"></td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="text" class="form form-control" name="hrg_jual" id="hrg_jual"
                    value="<?php echo $master_product_->getHrg_jual(); ?>" size="40"></td>
        </tr>
