...
function ajax_loadContent(divId,url)
{
	...
	var hostname = 'http://'+window.location.hostname+'/newMTGateway/';
	
	document.getElementById(divId).innerHTML = '<div align="center"><table border="0" cellpadding="0" style="border-collapse: collapse" width="90%"><tr><td><p align="center"><img border="0" src="'+hostname+'js/loading.gif"></td></tr></table></div>';
