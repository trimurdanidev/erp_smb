...
define('NICUPLOAD_PATH', 'images/upload'); // Set the path (relative or absolute) to
                                      // the directory to save image files
                                      
define('NICUPLOAD_URI', 'images/upload');   // Set the URL (relative or absolute) to
...
echo <<<END
    <html><body>
        <div id="uploadingMessage" style="text-align: center; font-size: 14px;">
            <img src="ajax-loader.gif" style="float: right; margin-right: 40px;" />
