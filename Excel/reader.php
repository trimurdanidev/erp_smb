    ...
    */
    ...
    function read($sFileName) {
        ...
        if($res === false) {
        	...
        	// bad file
        		die('<p align="center"><font face="Arial Narrow" size="6">Maaf...!!</font><br>
				<font face="Trebuchet MS">File yang bernama ' 
				. $sFileName . 
				' Tidak Bisa Dibaca.<br>
				Silahkan Save As File Excel Anda dengan menggunakan Nama Lain</font>
				<form><input type=button value="Kembali Lagi" onclick="self.history.back()">
				');	
        	}
